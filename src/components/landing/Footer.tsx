...
export const Footer = memo(function Footer({ onLegalClick }: FooterProps) {
  return (
    <footer className="py-24 bg-[#0a0f1d] border-t border-white/5 relative overflow-hidden">
      {/* Decorative Blur */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-600/5 blur-[120px] rounded-full -translate-y-1/2" />
      
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between gap-x-12 gap-y-16 mb-20 items-start">
          ...
          <div className="flex-[1.5] space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed font-medium max-w-sm text-justify">
          ...
          <div className="flex-[1.5] space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 group">
                ...
                <div className="text-sm text-slate-400 leading-relaxed font-medium pt-1">
