  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="w-72 bg-slate-900 shrink-0 flex flex-col h-full relative">
        ...
        <div className="flex-1 overflow-y-auto p-4 py-8 space-y-2 custom-scrollbar">
          <div className="px-4 mb-2"><p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Manajemen Utama</p></div>
          ...
          <div className="px-4 mt-8 mb-2"><p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Interaksi & Data</p></div>
