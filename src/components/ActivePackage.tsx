  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-slate-900 to-blue-900 rounded-2xl p-6 shadow-xl shadow-slate-900/20 h-full flex flex-col relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-amber-500/10 rounded-full translate-y-1/2 -translate-x-1/4 pointer-events-none" />
        ...
        <div className="relative z-10 flex-1 flex flex-col">
          ...
          <div className="mb-5 flex items-center gap-2 text-xs text-slate-400">
            ...
            <span>
              Berlaku hingga{" "}
              <span className="text-amber-400 font-semibold">{expiresDate}</span>
            </span>
          </div>

          <button className="w-full flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-white font-bold text-sm py-3 rounded-xl transition-all duration-300 hover:brightness-110 hover:shadow-lg hover:shadow-amber-500/30 group">
